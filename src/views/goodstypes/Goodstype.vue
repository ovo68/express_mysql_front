<template>
  <Content class="goodsBox">
    ...
    <Form id="searchForm" :model="formItem" :label-width="100" inline>
      <FormItem label="商品类型名称">
...
<script>
import {goodsTypeDel, goodsTypePage} from '@/api/goodstype'
import AddUpdate from './GoodstypeAddUpdate'

export default {
  name: 'GoodstypeAddUpdate',
  components: {
    AddUpdate,
  },
  data() {
